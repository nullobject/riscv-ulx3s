...
volatile uint16_t *VRAM = (uint16_t *)0x20000;
volatile uint8_t *LED = (uint8_t *)0x30000;
volatile uint8_t *UART0 = (uint8_t *)0x40000;
volatile uint8_t *UART1 = (uint8_t *)0x40004;
volatile uint16_t *ENCODERS = (uint16_t *)0x50000;
volatile uint32_t *PRNG = (uint32_t *)0x60000;
